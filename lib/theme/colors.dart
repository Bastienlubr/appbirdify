...
class AppColors {
  static const fernGreen = Color(0xFF427044);
  static const asparagus = Color(0xFF6A994E);
  static const yellowGreen = Color(0xFFA7C957);
  static const parchment = Color(0xFFF2E8CF);
